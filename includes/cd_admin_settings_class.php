<?php
	...
	function cookie_disclaimer_option() {
		...
		<form method="post" action ="options.php">
			...
			?>
			<div class="container">
			<h3>Disclaimer settings</h3>
			<hr>
				<ul class="nav nav-tabs">
					<li class="active"><a data-toggle="tab" href="#mobile">Desktop</a></li>
			...
			<div id="country" class="tab-pane fade">
					...
					<br>
					<br>
					<textarea class="settings"  style="width: 60%;height:350px;" disabled="true"></textarea>
