...
function enqueue_admin_script( $hook ) {
    ...
    wp_enqueue_script( 'boostrap_script', plugin_dir_url( __FILE__ ) . 'assets/js/bootstrap.min.js', array('jquery'), '1.0' );
    ...
    wp_enqueue_script( 'admin_script', plugin_dir_url( __FILE__ ) . 'assets/js/admin.js', array('jquery'), '1.0' );
    wp_enqueue_script( 'bootstrap_select_script', plugin_dir_url( __FILE__ ) . 'assets/js/bootstrap-select.js', array('jquery'), '1.0' );
